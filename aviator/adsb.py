...
def _decode_altitude(bits, type_code):
    ...
    return None
def _decode_cpr(bits, type_code):
...
def _decode_callsign(bits, type_code):
...
def _decode_velocity(bits, type_code):
